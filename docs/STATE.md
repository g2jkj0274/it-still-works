...
진행 중: 없음 — M1-6 전부 완료·커밋(2026-09-08). 다음은 M1-7 채집·배치 명령, 인벤토리
마지막 통과 테스트: 440/440 (tools/test.sh, 약 95초, 2026-09-08)
마지막 결정론 테스트: 통과 — 6f882498083ec79be4f9bea4ea5fe358cf09ccfb0f6684ea1ed9b0b656b9624e (M1-6a-2 갱신 2026-09-08, 별도 프로세스 3회 일치. M1-6b 4커밋 뒤 불변 재확인)
이터레이션 수: 13 (10마다 architect 전체 감사 — 10 완료, 다음 감사는 20)
...
- [ ] M1-7 시각(6b-2c 관찰): 시드 20250901 스폰 (8,8) 은 화면 4방향 중 왼쪽만 열려 있고 두 걸음 연속 허용 방향이 없다(지형 지대 경계). 플레이어 QA 때 첫 인상에 걸릴 수 있다 — 스폰 규칙은 DECISIONS 고정이므로 지형 표(ground_zones 밀도) 쪽에서 볼 것.
