...
const _NAMES: Dictionary[int, String] = {
    ...
    BlockType.FURNACE: "화로",
    BlockType.FURNACE_LIT: "화로",
    BlockType.BENCH: "작업대",
    BlockType.INGOT: "쇳덩이",
    BlockType.BRICK: "벽돌",
    BlockType.GLASS: "유리",
    BlockType.COOKED_CROP: "구운 작물",
    BlockType.IRON_DOOR_CLOSED: "튼튼한 문",
    BlockType.IRON_DOOR_OPEN: "튼튼한 문",
    BlockType.IRON_PICK: "쇠 곡괭이",
    BlockType.IRON_AXE: "쇠 도끼",
}
...
const _DESCRIPTIONS: Dictionary[int, String] = {
    ...
    BlockType.FURNACE: "작동기가 때리면 한 번 굽는다. 손으로는 돌지 않는다",
    BlockType.FURNACE_LIT: "불이 붙었다",
    BlockType.BENCH: "곁에 서면 쇳덩이가 드는 것을 만든다",
    BlockType.INGOT: "쇠 도구와 튼튼한 문에 든다",
    BlockType.BRICK: "단단하게 쌓는다",
    BlockType.GLASS: "빛이 지나가는 벽",
    BlockType.COOKED_CROP: "먹으면 배가 두 배로 찬다",
    BlockType.IRON_DOOR_CLOSED: "위협이 부수지 못한다",
    BlockType.IRON_DOOR_OPEN: "위협이 부수지 못한다",
    BlockType.IRON_PICK: "깊은 것까지 캔다",
    BlockType.IRON_AXE: "나무를 더 빨리 벤다",
